...
public class QuizDriver extends Application {
	...
	private ArrayList<QuizQuestion> questionList;  // each question selected 1-5
		...
		for (int i = 0; i < 10; i++) { // need 10 questions
		    while(true) {
		        ...
		        if (!generated.contains(next)) {
		        	questionList.add(questionBank.get(next));
		            generated.add(next); 
		            break;
		        }
		    }
	...
	public String getResultsString() {
		...
		String totalQuestions = " Total Questions On Quiz: 5 ";// + questionList.size();
